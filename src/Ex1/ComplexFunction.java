...
//(f1,min(f2,mul(f4,f5)))
    ...
    public static void main(String[] args) {
        function f1 = new Polynom("15x");
        function f2 = new Polynom("40x");
        function f3 = new Monom("70");
        function f4 = new Polynom( "x");
       ...
       // System.out.println("AFTER PLUS BDIKA:    "+bdika.op+"  op,   "+ bdika.left +"  left,  "+ bdika.right + "  right,  ");
        ...
        ComplexFunction cf2=new ComplexFunction(Operation.Times,f3,f4);
       ...
       /* ComplexFunction cf2=new ComplexFunction("plus(3x,4x)");
        ...
        System.out.println(cf3.equals(xcf2));*/
    }
